...
These two components are referred to as s-polarized and p-polarized light, respectively, and their reflection coefficients are given by the Fresnel equations below \cite{FresnelEquations2024}:
...
The \gls{dolp} is the degree to which light is polarized and can be defined as the ratio between the difference and the sum of the two polarization components.
...
The cameras use a 5MP \gls{cpfa} sensor from Sony, depicted in Figure \ref{fig:cpfa}, capabale of capturing both color and polarization information.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[B]{.49\textwidth}
        ...
        \caption{Colormap}
    \end{subfigure}
    \caption{Visualization of an image captured with a color polarization filter array sensor. Note how the polarization information facilitates detection of the small unmanned vessel.}
\end{figure}
