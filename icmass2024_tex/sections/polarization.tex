...
The cameras are equipped with a 5 MPixel \glsfirst{cpfa} sensor, depicted in Figure \ref{fig:cpfa}, capabale of capturing both color and polarization information.

\begin{figure}[H]
    \begin{subfigure}[B]{.48\textwidth}
        \includegraphics[width=\textwidth]{figures/sensor_layout.pdf}
        \caption{A 12\times12 slice of the color polarization filter array sensor, angles showin in top left corner. \label{fig:cpfa}}
    \end{subfigure}%
    \hfill
    \begin{subfigure}[B]{.48\textwidth}
    ...
    \begin{subfigure}[B]{.48\textwidth}
        ...
        \caption{Steps performed to transform the the data from \ref{fig:cpfa} to \ref{fig:cpfa_reorder}.}
    \end{subfigure}%
...
\begin{figure}[H]
    \begin{subfigure}[T]{.49\textwidth}
        ...
        \caption{S0, i.e. what a normal camera would capture.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[T]{.49\textwidth}
