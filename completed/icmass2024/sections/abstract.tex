\begin{abstract}
    ...
    Accurate synchronization of all sensors and the computer to \gls{utc} is achieved using a microcontroller for triggering and a custom \gls{pps}-enabled Linux kernel on the Jetson.
