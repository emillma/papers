...
\begin{figure}[H]
    \begin{subfigure}{.5\textwidth}
        ...
        % \caption{This particular layout uses a RGGB Bayer pattern with a $90^\circ$-$45^\circ$-$135^\circ$-$0^\circ$ polarization filter subdivision.}
    \end{subfigure}
    \hspace{2em}
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/sensor_packaging.pdf}
        \caption{Each group of 4\times4 pixels can be packed into a single pixel with 16 channels.}
